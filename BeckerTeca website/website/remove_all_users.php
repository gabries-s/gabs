...
<head>
    ...
    <title>BeckerTeca - Remover Usuarios</title>
...
<body>
    ...
    <header>
         <h1 onclick="window.location='cpanel.php';" style="cursor: pointer; font-size: 20px"><?php echo $configurations['titulo_site']; ?> - Remover Usuarios</h1>
    </header>
...
<form method="POST">
    ...
    <div class="tool-section">
        <h2 style='color:#d00;'>REMOVER TODOS OS USUÁRIOS?</h2>

       
		<label for="submit">Ao clicar no botão abaixo você removerá todos usuários registrados. Deseja prosseguir?</label>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    // Apagar todos os registros da tabela 'users', exceto onde adm = 1
    $sql = "DELETE FROM users WHERE adm != 1";

    if ($conn->query($sql) === TRUE) {
        createModal("Aviso!", "Os usuários foram apagados com sucesso, exceto o administrador!", "OK");
    } else {
        createModal("Erro!", "Erro ao remover os usuários: " . $conn->error, "OK");
    }
